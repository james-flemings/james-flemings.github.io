...
Hello! I am a fourth-year CS PhD student at the University of Southern California advised by Murali Annavaram in the [SCIP](https://scip-lab.usc.edu/) (Super Computing In Pocket) lab. I'm graciously funded by the [NSF Graduate Research Fellowship](https://nsfgrfp.org/). My research broadly investigates privacy in language models. In particular, I'm interested in (1) improving privacy reasoning of language models; (2) principally understanding and measuring privacy leakage of language models (memorization, inference-time auditing); (3) controlling privacy leakage of language models (differential privacy)
